...
public class CunWenAdapter extends BaseAdapter {
    ...
    private List<CunWen.ItemsEntity> list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
            if (convertView == null) {
                convertView = LayoutInflater.from(context).inflate(R.layout.cunwen_item, parent, false);
                convertView.setTag(new ViewHolder(convertView));
            }

            CunWen.ItemsEntity item = list.get(position);
    ...
    public void addAll(Collection<? extends CunWen.ItemsEntity> collection){
